...
You’re a data scientist at a cookie convention. What do you do? Survey the participants and fit a Gaussian mixture model, of course. 🍪 😋
...
You surveyed 1,000 cookie convention attendees to find out just how many cookies they could devour in a single day. Naturally, being the conscientious data scientist you are, you loaded the results into a `NumPy` array and fired up `Python` to crunch some summary statistics:
